...
public class ReviewService {
    ...
    @Transactional
    public ReviewResponseDto updateReview(ReviewRequestDto reviewRequestDto, Long id) throws Exception {
    ...
    @Transactional String deleteReview(Long id)throws Exception{
    ...
    private Review findReview(Long id)throws Exception{
        Review review = reviewRepository.findById(id).orElseThrow(ReviewNotFoundException::new);
        return review;
    }
    ...
    private void checkAuthorization(Review review)throws Exception{
